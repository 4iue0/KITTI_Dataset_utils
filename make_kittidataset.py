...
for cheetsheet in os.listdir('python/cheetsheets'):
    if cheetsheet == 'train.txt':
        output_dir = 'data/depth/train'
        mode = 'train'
    elif cheetsheet == 'val.txt':
    ...
    print(mode)
    i = 0
    with open(os.path.join('python/cheetsheets', cheetsheet)) as f:
        for rgb_path in tqdm.tqdm(f):
            ...
            if os.path.isfile(depth_path):
                ...
                output = function.fill_depth_colorization(rgb, depth[:,:,0])
